...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 5091921cb56b65346_20121031_facio");
		dinstaller_log("----------------------------------");
		...
		$currdata = parse_url("http://facio.com"); 
		...
		<form id="form-installer" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table-inputs">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="current_url" id="current_url" value="http://facio.com" readonly="true"  class="readonly" />
				...
				<tr>
					<td>Site Title</td>
					<td><input type="text" name="site_title" id="site_title" value="Facio" /></td>
				</tr>
			</table><br/>
